...
public class LojaController {
    ...
    //Cadastrar pedido
    @PostMapping
    public ResponseEntity<LojaoCompletoDto> cadastrarCarro(@RequestBody @Valid LojaoCompletoDto estacionamento)
    {
    ...
    //Buscar Pedidos
    @GetMapping
    public ResponseEntity<List<LojaoCompletoDto>> obterEstacionados()
    {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<LojaDto> obterEstacionadoPorId(@PathVariable String id)
    {
        Optional<LojaDto> retorno = servico.obterEstacionadoPorId(id);
    ...
    public ResponseEntity<LojaDto> atualizarEstacionado(@PathVariable String id, @Valid LojaDto estacionamento){
        Optional<LojaDto> retorno = servico.atualizarCarroPorId(id, estacionamento);
