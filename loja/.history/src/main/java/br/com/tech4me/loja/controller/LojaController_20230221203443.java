...
public class LojaController {
    ...
    //Atualizar pedido
    @PutMapping("/{id}")
    public ResponseEntity<LojaCompletoDto> atualizarCompraPorId(@PathVariable String id, @Valid LojaCompletoDto compra){
        Optional<LojaDto> retorno = servico.atualizarCompraPorId(id, compra);
