...
public class LojaController {
    ...
    {
        LojaCompletoDto compraCadastrada = servico.CadastrarCompra(compra);
    
        if (compraCadastrada.IsPresent()) {
            return new ResponseEntity<>(servico.CadastrarCompra(compra),HttpStatus.NOT_ACCEPTABLE); // ou algum outro status HTTP que deseje
        }
