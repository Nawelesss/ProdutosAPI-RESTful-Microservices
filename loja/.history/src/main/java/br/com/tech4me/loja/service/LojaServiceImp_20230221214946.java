...
public class LojaServiceImp implements LojaService{
    ...
    public Optional<LojaDto> obterCompraPorId(String id) {
        ...
        Optional<Loja> comprado = repository.findById(id),repository.atualizarCompraPorId(id, Produto );
        ...
        if(comprado.isPresent()){
            ...
            Itemcomprado.setDadosproduto(compraClient.atualizarVariavelBooleana(true));
