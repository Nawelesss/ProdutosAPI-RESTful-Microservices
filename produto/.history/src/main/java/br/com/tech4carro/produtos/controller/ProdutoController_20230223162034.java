...
public class ProdutoController {
   ...
   // }
    ...
    @PutMapping
    public ResponseEntity<ProdutoCompletoDto> atualizarBooleana(@PathVariable String vendido,@RequestBody @Valid 
    ProdutoCompletoDto dto ){
      Optional<ProdutoCompletoDto> retorno = servico.atualizarBooleana(vendido, dto);
    }
