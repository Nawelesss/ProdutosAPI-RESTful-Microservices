...
public class ProdutoServiceImpl implements ProdutoService{
    ...
    @Override
    public void atualizarBooleana(Boolean vendido,String id,ProdutoCompletoDto dto){
      Optional<Produto> retorno = repositorio.findById(id);
      
      if(retorno.isPresent()){
        Produto produto= new NewModelhttps://github.com/Nawelesss?tab=repositories().map(dto,Produto.class);
